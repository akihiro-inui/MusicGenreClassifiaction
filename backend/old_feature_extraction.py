...
from backend.centroid import centroid
from backend.dctmatrix import dctmatrix
from backend.melfilter import melfilter
from osc import osc
from backend.rolloff import rolloff
from backend.zerocrossing import zerocrossing
from src.data_process.datacleaner import datacleaner
...
# 2. Define instance
# ==============================================================================
class FramebasedFeatureExtraction:
    ...
    def __init__(self, file):
        ...
        if Srem == 1:
            ...
            for i in range(0, AFrameNum):
                ...
                Nonzeros = np.size(
                    (abs(audio[StartAnalysis:EndAnalysis]) > 0.0001).nonzero())  # Number of zeros in a frame
    ...
    def features(self):
        ...
        for l in range(0, self.TFrameNum):
            ...
            for jj in range(0, J):
                ...
                valley[jj] = min(
                    np.log10(Mframe[1:round(self.MScalebinstep / 2)]))  # Search valley from first half frame
